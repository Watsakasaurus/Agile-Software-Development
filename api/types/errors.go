...
// VaultError returns an system error object with prefix "Vault Error: "
...
var (
	...
	// ErrVaultError is raised if we get an unexpected error communicating with Vault
	ErrVaultError = SystemError("System Error Communicating with Vault")
